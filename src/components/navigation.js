        ...
        return(
            <nav className="navbar is-fixed-top" role="navigation" aria-label="main navigation">
                <div className="navbar-brand">
                    ...
                    <img src={logochat} alt="" width="120" height="130"/>

                    <a href="http://depthyeahrandomchat.herokuapp.com/" target="_blank">
                       
                        <i className="fa fa-paper-plane" aria-hidden="true"> chat </i>
                    </a>


                    <a href="https://shrouded-peak-88216.herokuapp.com/" target="_blank">
                          social chat recipe  
                    </a>
                    <a href="https://shrouded-peak-88216.herokuapp.com/" target="_blank">
                          social chat recipe  
